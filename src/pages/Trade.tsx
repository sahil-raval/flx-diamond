        ...
        <div style={{
          ...
          <div>
            ...
            <h3 style={{
              ...
              IF → FL Conversion<br />for Trade Partners
            </h3>
          </div>
          <div style={{ maxWidth: "440px" }}>
            <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.82)", lineHeight: 1.78, marginBottom: "28px" }}>
              The FL grade carries a material premium over IF that justifies conversion cost many
              times over at commercial scale. We assess stones, execute precision micro-regrind, and
              manage the GIA re-submission — delivering a certified Flawless diamond.
            </p>
